...
public class ConstanteUtil {
	public static final String BD_SCHEMA = "PPOS";
	public static final String BD_PCK_ADMINISTRACION = "PCK_PPOS_ADMINISTRACION";
	public static final String BD_PCK_VENTA = "PCK_PPOS_VENTA";
	...
	public static final String BD_PCK_REPORTE = "PCK_PPOS_REPORTE";
