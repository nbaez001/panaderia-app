...
CONNECT PSEG/1234@192.168.8.115/ORCL;
...
INSERT INTO PERMISO (ID,ID_PADRE,NOMBRE,RUTA,ORDEN) VALUES (PERMISO_SEQ.NEXTVAL,4,'Registrar parametros','/intranet/administracion/maestras',3);
INSERT INTO PERMISO (ID,ID_PADRE,NOMBRE,RUTA,ORDEN) VALUES (PERMISO_SEQ.NEXTVAL,5,'Resumen insumos','/intranet/reportes/insumos',1);
INSERT INTO PERMISO (ID,ID_PADRE,NOMBRE,RUTA,ORDEN) VALUES (PERMISO_SEQ.NEXTVAL,5,'Resumen ventas','/intranet/reportes/ventas',2);
